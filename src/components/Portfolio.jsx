        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white rounded-2xl border-3 border-black p-5 flex items-center space-x-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            ...
            <button className="bg-white text-black px-8 py-4 rounded-full text-base font-bold border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all">
              Explore Research Features
            </button>
          </div>

          <div className="relative">
            <div className="bg-white rounded-3xl border-4 border-black p-6 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transform rotate-1">
