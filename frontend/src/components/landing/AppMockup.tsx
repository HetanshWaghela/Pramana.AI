    ...
    return (
        <div className="relative">
            <div className="absolute top-0 right-0 flex flex-col items-end space-y-6">
                <motion.div
                    className="bg-white rounded-2xl border-4 border-black shadow-brutal p-5 w-80 transform rotate-2"
                ...
                <motion.div
                    className="bg-gradient-to-br from-blue-200 to-blue-300 rounded-2xl border-4 border-black shadow-brutal p-6 w-80 transform -rotate-1"
                    initial={{ opacity: 0, x: 60 }}
                    animate={{
                        opacity: 1,
                        x: 0,
                ...
                <motion.div
                    className="bg-gray-900 rounded-2xl border-4 border-black shadow-brutal p-5 w-80 transform rotate-1"
                    initial={{ opacity: 0, x: 60 }}
                    animate={{
                        opacity: 1,
                        x: 0,
